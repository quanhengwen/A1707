...
void rt_init_thread_entry(void* parameter)
{
    ...
    //优先级	14 
    /*========================================================*/
    tid = rt_thread_create("max9611", max9611_thread_entry, RT_NULL, 512, 14, 5);
    if (tid != RT_NULL)
        rt_thread_startup(tid); 
    /*========================================================*/
    //线程名称：RadioLink 占空比发送
    //优先级	13
    /*========================================================*/
    tid = rt_thread_create("sendRL", sendRLDuty_thread_entry, RT_NULL, 512, 13, 5);
    if (tid != RT_NULL)
        rt_thread_startup(tid);
    /*========================================================*/
		/*========================================================*/
    ...
    //优先级	13
    /*========================================================*/
    tid = rt_thread_create("outcontrol", outcontrol_thread_entry, RT_NULL, 512, 12, 5);
    if (tid != RT_NULL)
        rt_thread_startup(tid);
    /*========================================================*/
    //线程名称：指示灯   
